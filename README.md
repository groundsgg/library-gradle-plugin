...
- `paper-base-conventions`: Common configuration for velocity and paper plugins; relocates `com.google.protobuf` to `gg.grounds.shaded.protobuf` in final shaded plugin jars so server-bundled protobuf versions do not leak into plugin runtime
